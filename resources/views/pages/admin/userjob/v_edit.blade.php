...
<div class="conainter d-flex justify-content-center">
    <div class="card col-lg-6 text-sm">
        ...
        <div class="card-body mt-2">
            <form action="{{url('/update-job',$user->id)}}" method="POST">
                {{ csrf_field() }}
                <div class="form-group row">
                    <label for="editNo" class="col-sm-2 col-form-label text-right">No</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control-plaintext ml-2" id="id" name="id" value="{{$user->id}}" disabled>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <textarea name="job_desc" id="job_desc" cols="30" rows="5" class="form-control">{{$user->job_desc}}</textarea>
                  </div>
                </div>
                <div class="form-group row">
                    <label for="editCreate" class="col-sm-2 col-form-label text-right">Created At</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control-plaintext" id="created_at" name="created_at" value="{{$user->created_at}}" readonly>
                    </div>
                </div>
